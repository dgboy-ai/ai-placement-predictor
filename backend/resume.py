        ...
        <section className="dashboard-results">
          ...
          {result && (
            <div className="results-section">
              <div className="card overview-card mb-4 pop-in" style={{ display: 'flex', alignItems: 'center', gap: '2rem', marginBottom: '1.5rem' }}>
              ...
              <div className="details-stack">
                ...
                <div className="card pop-in" style={{animationDelay: '0.2s'}}>
                ...
                {result.issues && result.issues.length > 0 && (
                  <div className="card pop-in" style={{ borderLeft: '4px solid #ef4444', animationDelay: '0.4s' }}>
